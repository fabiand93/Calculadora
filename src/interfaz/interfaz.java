...
public class interfaz implements ActionListener{
    ...
    public interfaz(){
        ...
        jfMain.getContentPane().setLayout(new BorderLayout(4, 4));

        norte();
        sur();

        jfMain.getContentPane().add(panel, BorderLayout.NORTH);
        jfMain.getContentPane().add(pS, BorderLayout.CENTER);
        jfMain.setLocation(200, 180);
        jfMain.setResizable(false);
        jfMain.setVisible(true);
        jfMain.setSize(300, 280);
